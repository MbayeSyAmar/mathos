// ============================================
// DONNÉES STATIQUES - COURS, EXERCICES, QUIZ
// Toutes les données du projet Next.js original
// ============================================

// Cours statiques (IDs 1-30) - Données complètes avec objectives et prerequisites
window.staticCoursesData = {
  // 6ème
  1: {
    id: 1,
...
// Exercices statiques (IDs 1-21) - Données complètes avec hasCorrection
window.staticExercisesData = {
  1: {
    id: 1,
...
// Quiz statiques (IDs 1-9) - Données complètes avec popularity et category
window.staticQuizData = {
  1: {
    id: 1,
...
window.getStaticCourseById = function(id) {
  return window.staticCoursesData[id] || null;
};

window.getStaticExerciseById = function(id) {
  return window.staticExercisesData[id] || null;
};

window.getStaticQuizById = function(id) {
  return window.staticQuizData[id] || null;
};

window.getAllStaticCourses = function() {
  return Object.values(window.staticCoursesData);
};

window.getAllStaticExercises = function() {
  return Object.values(window.staticExercisesData);
};

window.getAllStaticQuizzes = function() {
  return Object.values(window.staticQuizData);
};
